...
describe("Template Builder", function() {
    ...
    describe("Text content", function() {
        it("Text content", function() {
            ...
            var output = templateBuilder(input)
            expect(output).to.equal('[m("h1", "Title")]')
        });
    ...
    describe("Nested tags", function() {
        it("Nested tag, 1 level", function() {
            ...
            var output = templateBuilder(input)
            expect(output).to.equal('[m("div", [m("p", "text")])]')
        });

        it("Nested tag, 2 levels", function() {
            var input = "<div><p><span>text</span></p></div>";
            var output = templateBuilder(input)
            expect(output).to.equal('[m("div", [m("p", [m("span", "text")])])]')
        });
    });
    ...
    describe("Attributes", function() {
        it("href", function() {
            ...
            var output = templateBuilder(input)
            expect(output).to.equal("[m(\"a[href='http://mithril.js.org']\", \"Mithril\")]")
        });

        it("Single style attribute", function() {
            var input = "<div style='color:#f00'>text</div>";
            var output = templateBuilder(input);
            expect(output).to.equal('[m("div", {style: {"color": "#f00"}}, "text")]')
        });

        it("Multiple style attributes", function() {
            var input = "<div style='color:#f00; border: 1px solid red'>text</div>"
            var output = templateBuilder(input)
            expect(output).to.equal('[m("div", {style: {"color": "#f00", "border": "1px solid red"}}, "text")]')
        });
    });
    ...
    describe("Tables", function() {
        it("Simple table", function() {
            ...
            var output = templateBuilder(input)
            expect(output).to.equal('[m("table", [m("tbody", [m("tr", [m("td")])])])]')
        });
        it("Table with thead and tfoot", function() {
            ...
            var output = templateBuilder(input)
            expect(output).to.equal('[m("table[cellpadding=\'6\'][frame=\'box\'][rules=\'groups\']", [m("thead", [m("tr", [m("th", "  weekday  "),m("th", "date"),m("th", "manager"),m("th", "qty")])]),m("tbody", [m("tr", [m("td", "mon"),m("td", "09/11"),m("td", "kelsey"),m("td", "639")]),m("tr", [m("td", "tue"),m("td", "09/12"),m("td", "lindsey"),m("td", "596")]),m("tr", [m("td", "wed"),m("td", "09/13"),m("td", "randy"),m("td", "1135")]),m("tr", [m("td", "thu"),m("td", "09/14"),m("td", "susan"),m("td", "1002")]),m("tr", [m("td", "fri"),m("td", "09/15"),m("td", "randy"),m("td", "908")]),m("tr", [m("td", "sat"),m("td", "09/16"),m("td", "lindsey"),m("td", "371")]),m("tr", [m("td", "sun"),m("td", "09/17"),m("td", "susan"),m("td", "272")])]),m("tfoot", [m("tr", [m("th[align=\'left\'][colspan=\'3\']", "total"),m("th", "4923")])])])]')
        });
    });
    ...
    describe("Images", function() {
        it("Image with attributes", function() {
            ...
            var output = templateBuilder(input)
            expect(output).to.equal('[m("img[alt=\'Movie star\'][src=\'https://raw.githubusercontent.com/ArthurClemens/assets/gh-pages/polythene/examples/avatar-1.png\']", {style: {"width": "128px", "height": "128px"}})]')
        });
    });
