  ...
  return {
    view: () => {
      ...
      try {
        ...
        rendered =
          'Could not render Mithril code - please check the output for any errors.';
      }
      return [
        m('.mtc-form.layout.justified.horizontal', [
          m('.mtc-block.mtc-source', [
            m(
              '.mtc-options',
              m(
                '.mtc-options-inner.pe-dark-tone',
                m(SmallButton, {
          ...
          m('.mtc-block.mtc-result', [
            m(
              ...
              m(
                ...
                m(
                  ButtonGroup,
                  Object.keys(attrsOptions).map(key => {
                    ...
                    return m(SmallButton, {
                      ...
                      events: {
                        onclick: e => (e.preventDefault(), setAttrs(key)),
                      },
                    });
                  }),
                ),
